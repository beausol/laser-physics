...
\end{equation}
where the three-index spatial coupling coefficient is given by
\begin{equation}
...
% \end{equation}
\begin{equation}
    \left[ \Gnb - 2\, B_q  / \Lq\right] E_q
    = \sum_{m n} \kappa_{q m n}\, C_{m - n} \left( B_m + B_n^\ast \right) E_m\, E_n^\ast\, E_{q - m + n}
\end{equation}
